...
<div class="card overflow-hidden">
  ...
  <div class="w-full flex items-center justify-between cursor-pointer" on:click={toggle}>
    <div class="flex items-center gap-3">
      ...
      <a
        ...
        class="font-medium text-gray-100 hover:text-indigo-300 transition-colors">{category.name}</a
      >
    </div>
