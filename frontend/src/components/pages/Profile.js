...
export const Profile = ({ getMyProfile, authData: { isAuthenticated }, profileData: { myProfile, loading } }) => {
  useEffect(() => {
        ...
        {myProfile && myProfile.user ? (
          <Fragment>
            ...
            <article className="profile">
              {myProfile.website ? (
                <div>
                  <a href={myProfile.website} target="_blank" rel="noopener noreferrer">
                    {myProfile.website}
                  </a>
                </div>
              ) : (
              ...
              {myProfile.biography ? <p className="biography">{myProfile.biography}</p> : <Fragment />}
