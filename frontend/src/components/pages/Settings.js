  ...
  return accounts === null || assets === null || expenditures === null || income === null || liabilities === null ? (
    ...
    <Fragment>
      <section className="box">
        ...
        <article className="articles">{income && income.map((i) => <IncomeEdit key={i.id} income={i} />)}</article>
        <hr />
        <IncomeEdit />
        ...
        <article className="articles">
          {expenditures &&
            expenditures.map((expenditure) => <ExpenditureEdit key={expenditure.id} expenditure={expenditure} />)}
        </article>
        <hr />
        <ExpenditureEdit />
