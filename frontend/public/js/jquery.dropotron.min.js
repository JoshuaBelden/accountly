    ...
    (e.dropotron = function (t) {
      ...
      n.on('doCollapseAll', function () {
            ...
            t
              ...
              .on('doExpand', function () {
                ...
                if (v) {
                  switch (
                    ...
                    case 'center':
                      (d = i.left - Math.floor((g - h) / 2)),
                        0 > d
                          ? ((d = i.left), (a = 'left'))
                          : d + g > l.width() && ((d = i.left - g + h), (a = 'right'));
                      break;
                    case 'left':
                    default:
                  ...
                  switch (
                    ('relative' == n.css('position') || 'absolute' == n.css('position')
                ...
                var C = !1;
                switch (
                  ((d = 'relative' == n.css('position') || 'absolute' == n.css('position') ? -1 * p.left : 0),
                  t.offset().left < 0
                    ? ((d += n.parent().outerWidth() - o.offsetX), (C = !0))
                    : t.offset().left + g > l.width() && ((d += -1 * n.parent().outerWidth() - o.offsetX), (C = !0)),
                  C && t.css('left', d + 'px'),
                  ...
                  case 'zoom':
                    (r = !0),
                      ...
                      t.animate({ width: 'toggle', height: 'toggle' }, o.speed, o.easing, function () {
                        r = !1;
                      });
                    break;
                  case 'slide':
                    (r = !0),
                      n.addClass(o.openerActiveClass),
                      t.animate({ height: 'toggle' }, o.speed, o.easing, function () {
                        r = !1;
                      });
                    break;
                  case 'fade':
              ...
              .on('doCollapse', function () {
                return t.is(':visible')
                  ? (t.hide(),
                    ...
                    t.find('.' + o.openerActiveClass).removeClass(o.openerActiveClass),
                    t.find('ul').hide(),
                    !1)
                  : !1;
              })
        ...
        n.children('li').each(function () {
          ...
          if (s.length > 0) {
            o.detach &&
              (o.cloneOnDetach && ((t = s.clone()), t.attr('class', '').hide().appendTo(s.parent())),
              s.detach().appendTo(i));
            for (var a = o.baseZIndex, l = 1, r = s; r.length > 0; l++)
              r.css('z-index', a++),
                o.submenuClassPrefix && r.addClass(o.submenuClassPrefix + (a - 1 - o.baseZIndex)),
                (r = r.find('> li > ul'));
          }
        }),
        l
