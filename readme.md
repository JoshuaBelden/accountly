...
A personal finance manager for the average person.

## TODO

- Transactions need to allow budget selection
...
- Transactions should be paged
- Batch delete transactions are needed
